        ...
        <section className='w-full min-h-[50vh] flex flex-col items-center justify-start gap-10 mt-20'>
            <div className='w-1/2 text-center mx-auto flex flex-col gap-3 justify-center items-center '>
                ...
                <motion.p initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true }} transition={{ delay: 0.4 }} className='text-lg text-muted-foreground max-w-2xl mx-auto font-hanken-grotesk'>Real developers. Real projects. Fewer late nights debugging things that should’ve been planned better. Forge helped them ship faster — and sleep slightly more.
                </motion.p>
            </div>
